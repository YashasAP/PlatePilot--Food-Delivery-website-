...
public class OrderDaoI implements OrderDao {
    final static String INSERT_QUERY = "INSERT INTO `orders` (restaurantId, userId, totalAmount, modeOfPayment, orderStatus, orderDate) VALUES (?, ?, ?, ?, ?, ?)";
    final static String SELECT_QUERY = "SELECT * FROM `orders` WHERE orderId=?";
    final static String UPDATE_QUERY = "UPDATE `orders` SET restaurantId=?, userId=?, totalAmount=?, modeOfPayment=?, orderStatus=?, orderDate=? WHERE orderId=?";
    final static String DELETE_QUERY = "DELETE FROM `orders` WHERE orderId=?";
    final static String SELECT_ALL_QUERY = "SELECT * FROM `orders`";
    final static String SELECT_BY_USER_ID_QUERY = "SELECT * FROM `orders` WHERE userId=?";
    final static String SELECT_BY_RESTAURANT_ID_QUERY = "SELECT * FROM `orders` WHERE restaurantId=?";

    private Connection connection;

    public OrderDaoI() {
        String url = "jdbc:mysql://localhost:3306/pilotfoods";
